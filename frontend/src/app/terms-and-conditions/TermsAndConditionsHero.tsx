        ...
        <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute inset-0 z-0">
                <Image
                    ...
                    alt="Terms and Conditions - Nepal Travel Co"
                    fill
                    priority
            ...
            <div className="relative z-20 text-center px-6">
                ...
                >
                    Terms & <span className="text-[var(--secondary)] italic font-light">Conditions</span>
                </motion.h1>
                ...
                >
                    Understand the terms that govern your travel arrangements and our commitment to providing exceptional service.
                </motion.p>
            </div>
