    ...
    return (
        <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
            ...
            <div className="relative z-20 text-center px-6">
                ...
                >
                    Get in <span className="text-[var(--secondary)] italic font-light">Touch</span>
                </motion.h1>
                ...
                >
                    Ready to explore the wonders of Nepal? Our experts are here to craft your perfect Himalayan adventure.
                </motion.p>
            </div>
