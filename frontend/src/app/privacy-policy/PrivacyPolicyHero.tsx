        ...
        <section className="relative h-screen w-full overflow-hidden flex items-center justify-center">
            ...
            <div className="absolute inset-0 z-0">
                <Image
                    ...
                    alt="Privacy Policy - Nepal Travel Co"
                    fill
                    priority
            ...
            <div className="relative z-20 text-center px-6">
                ...
                >
                    Privacy <span className="text-[var(--secondary)] italic font-light">Policy</span>
                </motion.h1>
                ...
                >
                    Learn how we protect your personal information and ensure your data privacy while planning your Nepal adventure.
                </motion.p>
            </div>
