    ...
    return (
        <div className="space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-admin-text-primary">Frequently Asked Questions</h2>
                    <p className="text-admin-text-secondary mt-1">Manage FAQs displayed on the homepage and contact pages.</p>
                </div>
                            ...
                            <TableRow key={faq.id} className="group">
                                <TableCell>
                                    <div className="flex items-start gap-4">
                                        <div className="h-10 w-10 rounded-lg bg-admin-bg border border-admin-card-border flex items-center justify-center mt-1 flex-shrink-0">
                                            <HelpCircle className="h-5 w-5 text-admin-accent" />
                                        </div>
                                        <div className="flex flex-col">
                                            <span className="font-bold text-admin-text-primary text-base group-hover:text-admin-accent transition-colors">{faq.question}</span>
                                            <span className="text-xs text-admin-text-secondary mt-1.5 leading-relaxed">{faq.answer}</span>
                                        </div>
                                    </div>
                                </TableCell>
                                <TableCell>
                                    <span className="text-[10px] font-black uppercase tracking-widest px-2.5 py-1 rounded-full bg-admin-bg border border-admin-card-border text-admin-text-secondary">
